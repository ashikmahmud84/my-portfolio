      ...
      >
        <Container size="wide">
          <nav aria-label="Main navigation" className="flex items-center justify-between">
            ...
            <a
              ...
              className="flex items-center gap-3 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#08090d] rounded-lg p-1"
              aria-label={`${developerProfile.name} - Home`}
            >
              <div className="w-9 h-9 rounded-lg bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center font-mono text-xs font-bold text-emerald-400 group-hover:border-emerald-500/60 group-hover:shadow-[0_0_12px_rgba(16,185,129,0.3)] transition-all">
                AA
              </div>
            ...
            <div className="hidden md:flex items-center gap-1 bg-[#10131d]/80 backdrop-blur-md border border-white/[0.08] rounded-full px-2 lg:px-3 py-1 shadow-inner">
              {navItems.map((item) => {
                ...
                return (
                  <a
                    ...
                    className={`text-xs font-medium px-2.5 lg:px-3.5 py-1.5 rounded-full transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 ${
                      isActive
            ...
            <div className="md:hidden flex items-center">
              <button
                ...
                className="p-2.5 rounded-lg text-neutral-300 hover:text-white bg-[#12151f] border border-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#08090d] transition-colors cursor-pointer"
        ...
        {mobileMenuOpen && (
          <>
            ...
            <div
              className="md:hidden fixed inset-0 top-[61px] bg-black/60 backdrop-blur-sm z-40 transition-opacity"
            ...
            <div
              ...
              className="md:hidden relative z-50 px-4 pt-3 pb-6 border-b border-white/10 bg-[#0c0f17]/95 backdrop-blur-2xl shadow-2xl animate-in fade-in slide-in-from-top-3 duration-200"
            >
                ...
                {navItems.map((item) => {
                  ...
                  return (
                    <a
                      ...
                      onClick={(e) => handleNavClick(e, item.href)}
                      aria-current={isActive ? 'page' : undefined}
                      className={`flex items-center justify-between py-2.5 px-3.5 rounded-xl text-sm font-medium transition-colors ${
                        isActive
                          ? 'text-emerald-300 bg-emerald-500/15 border border-emerald-500/25 font-semibold'
