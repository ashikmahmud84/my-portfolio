...
export const aboutContent = {
  ...
  subtitle: 'Computer Science & Technology student and Web Developer focused on modern full-stack web applications.',
  paragraphs: [
  ...
  education: [
    {
      ...
      periodOrYear: '8th Semester (Expected 2027)'
    },
    {
  ...
  journey: [
    {
      ...
      description: 'Began exploring computer science fundamentals and started the journey of software engineering with curiosity and dedication.',
      technologies: ['Programming Fundamentals', 'Problem Solving', 'Git']
    },
    {
      title: 'Learned HTML, CSS and JavaScript',
      description: 'Mastered semantic HTML5, responsive CSS3 layouts, modern design principles, and core JavaScript fundamentals.',
      technologies: ['HTML5', 'CSS3', 'JavaScript (ES6+)', 'Responsive Web Design']
    },
    {
      title: 'Progressed into React & Modern Frontend Development',
      description: 'Transitioned into component-driven development with React, dynamic state management, custom hooks, and Tailwind CSS.',
      technologies: ['React', 'React Hooks', 'Tailwind CSS', 'Vite', 'Component Architecture']
    },
    {
      title: 'Learned Node.js, Express & MongoDB',
      description: 'Expanded into backend development, constructing modular RESTful APIs with Node.js and Express, and persistent database schemas with MongoDB.',
      technologies: ['Node.js', 'Express.js', 'MongoDB', 'Database Modeling']
    },
    {
      title: 'Built Full-Stack Projects',
      description: 'Applied full-stack knowledge to real-world applications, integrating responsive frontends with database-backed server endpoints.',
      technologies: ['MERN Stack', 'Full-Stack Integration', 'CRUD Workflows']
    },
    {
      title: 'Worked with Authentication, APIs & Databases',
      description: 'Implemented secure user authentication, token-based authorization (JWT), RESTful API design, and robust database management.',
      technologies: ['JWT Authentication', 'REST APIs', 'Security Practices', 'Database Queries']
    },
    {
      title: 'Currently Exploring Next.js & Improving Full-Stack Skills',
      description: 'Expanding full-stack development skills with Next.js, server components, production optimization, and modern architectural standards.',
      technologies: ['Next.js', 'Full-Stack Web Development', 'Clean Architecture'],
      isCurrent: true
    }
  ] as JourneyMilestone[]
};
